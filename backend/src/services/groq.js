...
- home_trips ("Home Trips / Other Trips / Home Needs"): trips home (flights home, spending while visiting home) AND any other trip OUTSIDE the UAE (holiday abroad - flights, visa, hotel, food, tickets, shopping there). ALSO everything for family or girlfriend back in the home country: money sent/transferred home, mom/family/girlfriend using the user's card (e.g. online shopping), and gifts bought for them - even if bought here.
